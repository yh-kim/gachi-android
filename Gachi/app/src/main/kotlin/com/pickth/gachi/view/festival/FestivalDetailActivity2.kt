...
import kotlinx.android.synthetic.main.activity_festival_detail2.*

class FestivalDetailActivity2: BaseActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_festival_detail2)
...
//        val icon = ContextCompat.getDrawable(this, R.drawable.ic_gachi)
        ...
        setSupportActionBar(festival2_toolbar)
        ...
        iv_festival2_detail.setBackgroundResource(image)
        Glide.with(this)
                .load(image)
                .apply(RequestOptions.bitmapTransform(MyBlurTransformation(this)))
                .into(object: SimpleTarget<Drawable>() {
                    override fun onResourceReady(resource: Drawable?, transition: Transition<in Drawable>?) {
                        iv_festival2_background.background = resource
                    }
                })
    }
